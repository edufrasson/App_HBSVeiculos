...
<div class="data-container">    
    <box-icon name='import' id="importButton" class="data-buttons" title="Importar dados"></box-icon>
    <box-icon name='export' id="exportButton" class="data-buttons" title="Exportar dados"></box-icon>
</div>